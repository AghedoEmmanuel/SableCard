       ...
       <div className='md:px-24'>
        ...
        <div className='absolute md:top-40 md:left-8 flex md:px-14 top-3 right-3'>
            <div className='md:px-20 md:space-y-6 px-6'>
                <h1 className='font-bold md:text-xl md:tracking-wider'>Join-over <span className='md:text-5xl'>400,000</span> accounts</h1>
                <p>Download Sable: effortless, borderless banking for a more connected world.</p>
            </div>
